...
```bash
./gradlew :app:testDebugUnitTest         # 163 JVM unit tests — the primary gate
...
comes from fast JVM tests. **209 tests, 163 of which run without a device.**

| Scope | Tests |
|---|---|
| Models, rules, reducer, formatters | 66 |
| Use cases, repositories, serializer | 53 |
| ViewModels — state, effects, virtual-time clock | 44 |
