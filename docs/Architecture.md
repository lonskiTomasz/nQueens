...
| Appearance | Light or dark, a stored player choice rather than the system value (§7)                       |
...
identity, and Material You would repaint exactly the semantics the player reads. Light and dark are
a **player choice**, seeded from the system on first launch.
...
| 12 | Theme is a stored player choice, seeded from the system at first launch                 | Always follow `isSystemInDarkTheme()`; a three-way System / Light / Dark control                                                   | The toggle has two segments, so there is no state to represent "follow system" once the player has chosen. Reading the system value once gives a sensible default without a third option. A settings screen could reintroduce a system option later.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
